...
namespace LeaveManagement.Web.Controllers
{
    ...
    public class LeaveAllocationsController : Controller
    {
        ...
        {
            if (id == null || _context.LeaveAllocations == null)
            {
                return NotFound();
            }
        ...
        public async Task<IActionResult> Create([Bind("LeaveTypeId,EmployeeId,Year,Id,DateCreated,DateModified")] LeaveAllocation leaveAllocation)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("LeaveTypeId,EmployeeId,Year,Id,DateCreated,DateModified")] LeaveAllocation leaveAllocation)
        {
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'ApplicationDbContext.LeaveAllocations'  is null.");
            }
            var leaveAllocation = await _context.LeaveAllocations.FindAsync(id);
            if (leaveAllocation != null)
            {
        ...
        {
          return (_context.LeaveAllocations?.Any(e => e.Id == id)).GetValueOrDefault();
        }
    }
}
