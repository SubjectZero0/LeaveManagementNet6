...
namespace LeaveManagement.Web.Areas.Identity.Pages.Account
{
    public class RegisterModel : PageModel
    {
        ...
        /// <summary>
        /// View Model for registration page
        /// </summary>
        public class InputModel
        {
            ...
            [StringLength(100, ErrorMessage = "Enter a Valid First Name", MinimumLength = 2)]
            public string FirstName { get; set; }

            [Required]
            [Display(Name = "Last Name")]
            [StringLength(100, ErrorMessage = "Enter a Valid Last Name", MinimumLength = 2)]
            public string LastName { get; set; }

            [Required]
            [Display(Name = "Tax Number")]
            [StringLength(15, ErrorMessage = "Enter a Valid Tax Number", MinimumLength = 15)]
            ...
            [DataType(DataType.Date)]
            public DateTime DateJoined { get; set; } = DateTime.Now; // Default is Now on creation.
        }
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    await _userManager.AddToRoleAsync(user, UserRoleConstants.User); //new registrations are assigned the role User automatically
